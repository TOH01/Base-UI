...
// the slider is contained in a rectangular space. It will always fit within the size of that
// Rectangle. With spacings the slider can be modified.
...
#define IFDEF_TITLEBAR_DARKMODE                                                       \
    , .titlebar = {RGB(37, 37, 38)}, .close = {RGB(232, 17, 35), RGB(255, 255, 255)}, \
...
#define IFDEF_TITLEBAR_LIGHTMODE                                                   \
    , .titlebar = {RGB(255, 255, 255)}, .close = {RGB(232, 17, 35), RGB(0, 0, 0)}, \
...
#define IFDEF_TITLEBAR_OCEAN                                                          \
    , .titlebar = {RGB(230, 245, 250)}, .close = {RGB(232, 17, 35), RGB(15, 32, 39)}, \
...
#define IFDEF_TITLEBAR_CASTLECLASH                                                       \
    , .titlebar = {RGB(156, 130, 102)}, .close = {RGB(180, 50, 50), RGB(255, 255, 255)}, \
